...
Past about five metres from the centre line the car is off the tarmac and keeps roughly two thirds of its top speed: 41 mph for the coastal wagon against 63, 54 for the Apex Formula against 89. The limit eases down to that over about a second and a half rather than arriving at the white line, so leaving the road costs momentum you feel draining away instead of speed the game takes. The order is the character: the pickup, and the desert and jungle cars, keep about 70% of their top end, the van and hatchback about 62%, and the two racers the least. Coming back onto the tarmac restores the full limit at once, so running wide out of a bend and correcting is worth doing, and loose ground also drags harder on a closed throttle. Guardrails and the soft roadside limit are separate and unchanged; see [Coastal guardrails](#coastal-guardrails).
